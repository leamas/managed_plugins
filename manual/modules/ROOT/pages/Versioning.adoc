...
An example:
    ...
    3.0.1+456.0a59905_fedora-34-x86_64
...
That is, if the git tag is _v1.0.3-alpha1_ the version in _v1.0.3-alpha1_,
...
drawback is that this mean that the version needs to be defined **both** in
